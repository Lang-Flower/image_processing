...
for i=1:size(data_2,1)
    ...
    elseif ~(isempty(state_2{i,2})) && all(state_2{i,2}=='SS')
        ss_2=loglog(data_2(i,9)/data_2(i,5)/1000,data_2(i,13),'rs','Markersize',7,'Linewidth',2);
        hold on
    elseif ~(isempty(state_2{i,2})) && all(state_2{i,2}=='CS')
        cs_2=loglog(data_2(i,9)/data_2(i,5)/1000,data_2(i,13),'ro','Markersize',7,'Linewidth',2);
        hold on
    elseif ~(isempty(state_2{i,2})) && all(state_2{i,2}=='WS')
        ws_2=loglog(data_2(i,9)/data_2(i,5)/1000,data_2(i,13),'r+','Markersize',7,'Linewidth',2);
        hold on
    end
end
...
for i=1:size(data_5,1)
    ...
    elseif ~(isempty(state_5{i,2})) && all(state_5{i,2}=='SS')
        ss_5=loglog(data_5(i,9)/data_5(i,5)/1000,data_5(i,13),'ms','Markersize',7,'Linewidth',2);
        hold on
    elseif ~(isempty(state_5{i,2})) && all(state_5{i,2}=='CS')
        cs_5=loglog(data_5(i,9)/data_5(i,5)/1000,data_5(i,13),'mo','Markersize',7,'Linewidth',2);
        hold on
    elseif ~(isempty(state_5{i,2})) && all(state_5{i,2}=='WS')
        ws_5=loglog(data_5(i,9)/data_5(i,5)/1000,data_5(i,13),'m+','Markersize',7,'Linewidth',2);
        hold on
    end
end
...
for i=1:size(data_10,1)
    ...
    elseif ~(isempty(state_10{i,2})) && all(state_10{i,2}=='SS')
        ss_10=loglog(data_10(i,9)/data_10(i,5)/1000,data_10(i,13),'bs','Markersize',7,'Linewidth',2);
        hold on
    elseif ~(isempty(state_10{i,2})) && all(state_10{i,2}=='CS')
        cs_10=loglog(data_10(i,9)/data_10(i,5)/1000,data_10(i,13),'bo','Markersize',7,'Linewidth',2);
        hold on
    elseif ~(isempty(state_10{i,2})) && all(state_10{i,2}=='WS')
        ws_10=loglog(data_10(i,9)/data_10(i,5)/1000,data_10(i,13),'b+','Markersize',7,'Linewidth',2);
        hold on
    end
end
